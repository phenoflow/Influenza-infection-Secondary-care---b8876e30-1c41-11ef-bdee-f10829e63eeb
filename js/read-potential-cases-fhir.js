...
(async () => {
  ...
  await fs.writeFile("influenza-infection-secondary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("influenza-infection-secondary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
